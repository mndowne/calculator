$(document).ready(function(){
        ...
        $(document).keypress(function(key){
                ...
                switch (key.keyCode || key.charCode){
                case 13:
                enterEnter();
                break;
                case 33:
        ...
        function orderOfOperations(n) {
            ...
            if (firstOperation !== -1){
                ...
                if (earlyOperator == undefined)
                {
                    earlyOperator = -1;
                }
                var laterOperator = operations[operator + 1];
                if (laterOperator == undefined)
                {
                    laterOperator = screenStrin.length;
                }
                ...
                var answer = Number(screenStrin.substring(earlyOperator+1,currentOperator)) / 
                    Number(screenStrin.substring(currentOperator+1,laterOperator));
                screenStrin = screenStrin.split("");
                screenStrin.splice(earlyOperator+1,laterOperator - (earlyOperator+1),answer);
                screenStrin = screenStrin.join("");
                return screenStrin;
                ...
                var answer = 
                    Number(screenStrin.substring(earlyOperator+1,currentOperator))* 
                    Number(screenStrin.substring(currentOperator+1,laterOperator));
